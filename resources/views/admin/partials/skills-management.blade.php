<div class="mb-8 flex justify-between items-center">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Manage your technical skills and proficiency levels.</p>
    </div>
...
<div class="bg-white shadow rounded-lg">
    <div class="p-6">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            @foreach(['HTML' => 95, 'CSS' => 85, 'JavaScript' => 90, 'PHP' => 90] as $skill => $percentage)
